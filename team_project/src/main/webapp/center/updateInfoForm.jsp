...
<body>
	...
	<div align="center" >
			...
			<table class="tb" >
				...
				<tr>
					<th>마케팅 수신동의</th>
					<td><input type="radio" name="marketing_agree" onchange="marketingCheck()" value="true">동의 
					<input type="radio" name="marketing_agree" onchange="marketingCheck()" value="false">동의 안함 
					</td>
					<td colspan="3"><input type="button" value="비밀번호 변경" onclick="marketingCheck()"></td>
				</tr>
			</table>
