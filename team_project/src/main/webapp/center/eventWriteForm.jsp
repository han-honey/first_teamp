...
<body>
	...
	<!-- 헤더 들어가는곳 -->
	<div class="container">
		<div id="eventWriteInfo">
			<form action="./EventWritePro.bo" method="post" enctype="multipart/form-data">
				<table border="1" id="notice" class="table table-hover">
					<tr>
						<td>작성자</td>
						<td><input type="text" name="name" value="<%=id%>" readonly="readonly" class="form-control" ></td>
					</tr>
					<tr>
						<td>제목</td>
