			...
			<table class="table table-hover">
				...
				<tbody>
 				...
 				if (articleList != null && articleList.size() > 0) {
 					for (BoardDTO Board : articleList) {
				%>
				<tr style="cursor: pointer;"
					onclick="location.href='./NoticeContent.bo?idx=<%=Board.getIdx()%>&page=<%=pageNum%>'">
					<td><%=Board.getIdx()%></td>
...
<!-- 				게시물 목록이 없을 경우 -->
			...
			<div>
				<input type="button" class="site-btn" style="float: right;" value="공지사항 작성" 
		...
		<div class="container">
			<div id="page_control" style="text-align: center; font-size: 16px;">
				...
				%>
				<input type="button" value="&lt;" onclick="location.href='./NoticeList.bo?page=<%=pageNum - 1%>'">
				<%
				}
				%>
				...
				%>
				<input type="button" value="<%=i%>" onclick="location.href='./NoticeList.bo?page=<%=i%>'">
				<%
				}
				%>
				<%
