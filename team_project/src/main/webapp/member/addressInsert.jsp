...
<body>
	<div align="center">
			...
			<table>
				...
				<tr>
				<th>주소</th>
				<td><input type="text" id="sample6_address" name="address" placeholder="주소" readonly="readonly" required="required"></td>
				</tr>
				<tr>
				<th>상세주소</th>
				<td><input type="text" id="sample6_detailAddress" name="extra_address" placeholder="상세주소"></td>
				</tr>
				<tr>
				<th>참고항목</th>
				...
				<tr>
				<th>요청메세지</th>
				<td><input type="text" name="request_message" placeholder="요청메세지"></td>
				</tr>
				<tr>
				<th>기본배송지</th>
