...
public class BoardEventModifyProAction implements Action {
	...
	public ActionForward execute(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		board.setEvent_idx(Integer.parseInt(request.getParameter("idx")));
		...
		boolean isModifySuccess = boardEventModifyProService.modifyArticle(board);
			...
			if(!isModifySuccess) { 
				...
				forward.setPath("EventContent.bo?idx=" + board.getEvent_idx() + "&page=" + request.getParameter("page"));
