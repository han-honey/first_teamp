...
public class PaymentCartAllDeleteService {
	
	public int cartAllDelete(String sessionId) {
		System.out.println("PaymentCartAllDeleteService - cartAllDelete() 메서드 호출");
		...
		deleteAllCount = cartDAO.cartAllDelete(sessionId);
