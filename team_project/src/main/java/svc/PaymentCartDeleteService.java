...
public class PaymentCartDeleteService {
	
	public int cartDelete(String sessionId, String[] product_code) {
		System.out.println("PaymentCartDeleteService - cartDelete() 메서드 호출");
		int deleteCount = 0;
		...
		deleteCount = cartDAO.cartDelete(sessionId, product_code);
